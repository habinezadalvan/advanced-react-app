  ...
  return (
    ...
    <div className="right-section">
        <div className="upper-part">
            <p>
                {(props.process && props.process[0].text)  || `These are the essential steps of how we do what we do.`}
            </p>
        </div>
    ...
    <div className="design-button">
        <div className="left">
            <img src={(props.process && props.process[0].icon) || images.together} alt= {(props.process && props.process[0].title) || 'icon'}/>
        </div>
  <div className="right">{(props.process && props.process[0].title) || 'welcome'}</div>
    </div>
</div>
  );
};
